...
//https://${postName}/api/l3rH7uT47PTrQSteWO2V9XqbpRn1/ordermealdetail?token=$2a$10$kz537bPMcWJrY40CIkayQO0cfKA0wBPMCIaFiT7HGgpfGS0dnB.ue
...
function orderDetail(orderStatus) {
  ...
  fetch(`https://${postName}/api/${userId}/vorderdisplay?token=${token}&orderstatus=${orderStatus}&userid=${userId}`,
    {
      method: "GET"
